#pragma checksum "G:\winui-local-movie\winui-local-movie\AllVideosPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "AA2B7AB057C6CDBC96C21A93F32B15C8616A95166CC636CE2D885A4A37CCDA4F"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IAllVideosPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 82 && columnNumber == 24)
                {
                ...
                else if (lineNumber == 59 && columnNumber == 23)
                {
                ...
                else if (lineNumber == 73 && columnNumber == 23)
                {
            ...
            private bool TryGet_IsWatchLater(out global::System.Boolean val)
            {
                global::winui_local_movie.VideoModel obj;
                if (TryGet_(out obj) && obj != null)
                {
                    val = obj.IsWatchLater;
                    return true;
                }
                else
                {
            ...
            private void Invoke_M_GetFavoriteIcon_543608894(int phase)
            {
                global::System.Boolean p0;
                if (!TryGet_IsFavorite(out p0)) { return; }
                global::System.String result = this.dataRoot.GetFavoriteIcon(p0);
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // AllVideosPage.xaml line 42
                    if (!isobj11ContentDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_ContentControl_Content(this.obj11, result, null);
                    }
                }
            }

            private void Invoke_M_GetFavoriteColor_543608894(int phase)
            {
                global::System.Boolean p0;
                if (!TryGet_IsFavorite(out p0)) { return; }
                global::Microsoft.UI.Xaml.Media.SolidColorBrush result = this.dataRoot.GetFavoriteColor(p0);
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // AllVideosPage.xaml line 42
                    if (!isobj11ForegroundDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_Control_Foreground(this.obj11, result, null);
                    }
                }
            }

            private void Invoke_M_GetWatchLaterIcon_3125110521(int phase)
            {
                global::System.Boolean p0;
                if (!TryGet_IsWatchLater(out p0)) { return; }
                global::System.String result = this.dataRoot.GetWatchLaterIcon(p0);
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // AllVideosPage.xaml line 52
                    if (!isobj12ContentDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_ContentControl_Content(this.obj12, result, null);
                    }
                }
            }

            private void Invoke_M_GetWatchLaterColor_3125110521(int phase)
            {
                global::System.Boolean p0;
                if (!TryGet_IsWatchLater(out p0)) { return; }
                global::Microsoft.UI.Xaml.Media.SolidColorBrush result = this.dataRoot.GetWatchLaterColor(p0);
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // AllVideosPage.xaml line 52
                    if (!isobj12ForegroundDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_Control_Foreground(this.obj12, result, null);
                    }
                }
            }
            ...
            private void Update_(global::winui_local_movie.VideoModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_M_GetFavoriteIcon_543608894(phase);
                        this.Update_M_GetFavoriteColor_543608894(phase);
                        this.Update_IsWatchLater(obj.IsWatchLater, phase);
                        this.Update_M_GetWatchLaterIcon_3125110521(phase);
                        this.Update_M_GetWatchLaterColor_3125110521(phase);
            ...
            private void Update_M_GetFavoriteIcon_543608894(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    if (!isobj11ContentDisabled)
                    {
                        this.PendingFunctionBindings["M_GetFavoriteIcon_543608894"] = new InvokeFunctionDelegate(this.Invoke_M_GetFavoriteIcon_543608894); 
                    }
                }
            }
            private void Update_M_GetFavoriteColor_543608894(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    if (!isobj11ForegroundDisabled)
                    {
                        this.PendingFunctionBindings["M_GetFavoriteColor_543608894"] = new InvokeFunctionDelegate(this.Invoke_M_GetFavoriteColor_543608894); 
                    }
                }
            }
            private void Update_IsWatchLater(global::System.Boolean obj, int phase)
            {
                this.Update_M_GetWatchLaterIcon_3125110521(phase);
                this.Update_M_GetWatchLaterColor_3125110521(phase);
            }
            private void Update_M_GetWatchLaterIcon_3125110521(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    if (!isobj12ContentDisabled)
                    {
                        this.PendingFunctionBindings["M_GetWatchLaterIcon_3125110521"] = new InvokeFunctionDelegate(this.Invoke_M_GetWatchLaterIcon_3125110521); 
                    }
                }
            }
            private void Update_M_GetWatchLaterColor_3125110521(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    if (!isobj12ForegroundDisabled)
                    {
                        this.PendingFunctionBindings["M_GetWatchLaterColor_3125110521"] = new InvokeFunctionDelegate(this.Invoke_M_GetWatchLaterColor_3125110521); 
                    }
                }
            }
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 2: // AllVideosPage.xaml line 18
                ...
                break;
            case 3: // AllVideosPage.xaml line 95
                {
            ...
            case 5: // AllVideosPage.xaml line 102
                ...
                break;
            case 8: // AllVideosPage.xaml line 29
                {
